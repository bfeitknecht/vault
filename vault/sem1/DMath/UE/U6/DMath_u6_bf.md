...
$$f_{n} \{0,\,1\} \overset{def}{=} \begin{cases} {0, } & \text{for f_n(0)}\\ \mbox{\{1\}^n 0^\infty , } & {for n} \end{cases}$$

$f\{0,\,1\} \rightarrow \{0, 1\}^\infty$

$$f_n: \{0,\,1\} \overset{def}{=} \begin{cases} 0\quad\quad\quad\\text{, for $f_n(0)$}\\\{1\}^n \{0\}^\infty, \quad\text{for } \end{cases}$$
